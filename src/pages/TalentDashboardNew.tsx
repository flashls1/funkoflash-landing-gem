...
const TalentDashboardNew = () => {
  ...
  const fetchUpcomingEvents = async () => {
    ...
    try {
      ...
      const allEvents = [
        ...(calendarEvents || []).map(event => ({ ...event, type: 'calendar' })),
        ...(businessEvents || []).map(event => ({ ...event, type: 'business' }))
      ].sort((a, b) => {
  ...
  return (
    <div className="min-h-screen" style={{
      backgroundImage: `url(${profile?.background_image_url || '/lovable-uploads/d0f4637c-55b5-42eb-af08-29eabb28b253.png'})`,
...
export default TalentDashboardNew;