...
CREATE POLICY IF NOT EXISTS "Users with calendar:edit can manage all events" 
...
CREATE POLICY IF NOT EXISTS "Users with calendar:edit_own can manage their own events" 
ON public.calendar_event 
FOR ALL 
USING (
  EXISTS (
