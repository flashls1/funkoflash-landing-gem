-- H1) Fix Jesse's BAU relationship
insert into public.business_account_user (business_account_id, user_id, role)
select '26bf6937-6214-402e-9f48-82f2e8e4cf27'::uuid, p.user_id, 'member'
from public.profiles p
where lower(p.email) = 'dsocial@live.com'
on conflict (business_account_id, user_id) do nothing;

-- H2) Link COLLECTORS COLLISION event to Jesse's business
...
-- H3) Fix the validator function (column ambiguity bug)
