-- COMPREHENSIVE FIX: Create calendar events for existing business events and test system

-- Step 1: Get admin user ID for calendar event creation (since only admin/staff can create)
DO $$
DECLARE
  admin_user_id UUID;
  business_event_record RECORD;
  new_calendar_event_id UUID;
BEGIN
